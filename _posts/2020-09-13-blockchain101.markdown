...
#### Types of blockchain 
There are basically 4 main types of blockchain: public blockchains, private blockchains, consortium blockchains and hybrid blockchains. We will briefly describe each types.
